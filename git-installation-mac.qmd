...
4.  **Verify Installation in RStudio**
    -   **Important**: Close and reopen RStudio (or its terminal pane) to update the PATH environment variable.
    -   Open a new terminal in RStudio: `Tools > Terminal > New Terminal`.
    -   Type `git --version` and press Enter. You should see the Git version (e.g., `git version 2.43.0`). **!** If you want to copy and paste, but it doesn't work with <kbd>Ctrl + V</kbd> or <kbd>Cmd + V</kbd>, use <kbd>Shift + Insert</kbd>, or Edit-\>Paste
...
### [Proceed with GitHub Complete workflow](@RStudio-GitHub-workflow) \| [Return to Section Overview](/index.qmd)
