...
1.  **Open the Terminal in RStudio:**
    ...
    -   In RStudio, go to `Tools > Terminal > New Terminal`. This will open a command-line interface directly within RStudio. You can also open the existing terminal window, bottom left, right of the 'Console' tab.
