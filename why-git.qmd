...
**Git** is the de facto standard version control system (https://git-scm.com/). Think of it as a tool that tracks every change you make to your files. It creates a complete history of your project, allowing you to revert to previous versions, compare changes, and work on different features without affecting the main code. It operates locally on your computer.

Git is free, open-source, trademarked by a US American non-profit organization that supports free and open source software projects: https://en.wikipedia.org/wiki/Software_Freedom_Conservancy
...
GitHub is part of Microsoft. There are alternatives, e.g. Codeberg (non-profit; https://en.wikipedia.org/wiki/Codeberg) or BitBucket (https://en.wikipedia.org/wiki/Bitbucket), but GitHub is the most widely used platform.
As a further primer for later, this 2016 PLOS paper https://doi.org/10.1371/journal.pcbi.1004668 with accompanying files on GitHub https://github.com/jdblischak/git-for-science might be helpful (but it only uses command line code).
...
![Git workflow diagram](git_worklflow.png)