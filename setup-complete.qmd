...
2.   **Git Housekeeping**
     ...
     - **Unfortunately, the possible integration of RStudio using Git with authentication that was installled with GitHub Desktop seems unstable. If you have GitHub Desktop installed and your access authenticated, check in RStudio under
     Tools -> Global Options -> Git/SVN -> Git executable:
     This has to point to 'git.exe'.**
...
3.   **Configure Git (First-Time Setup):**
     ...
     ```
     * User email has to be the email used for your github.com login. This can be found on github.com, by clicking on your profile picture -> **Settings** -> **Emails**. You can use your actual email address, or, alternatively, there is a more anonymous email that can be used (look on that page for the email, ending in @users.noreply.github.com)
     
     * Your Name can be your GitHub user name, but doesn't have to be.
