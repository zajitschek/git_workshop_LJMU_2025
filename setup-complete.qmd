...
2.  **Git Housekeeping**
    ...
    -   **Unfortunately, the possible integration of RStudio using Git with authentication that was installled with GitHub Desktop seems unstable. If you have GitHub Desktop installed and your access authenticated, check in RStudio under Tools -\> Global Options -\> Git/SVN -\> Git executable: This has to point to 'git.exe'.**

    -   **If you have GitHub Desktop installed and RStudio is linked to the correct 'git.exe', jump to point 6. You might be able to proceed with the authentication used by GitHub Desktop. If 6. doesn't work for you, come back here and proceed with 3.**
