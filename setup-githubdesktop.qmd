...
**To use Git on your local computer, you need to have the standalone Git version installed, for both GitHub Desktop and for using Git from RStudio**

[**Verify whether Git is installed**](verify-git.qmd) <br><br><br>

You should have Git installed on your computer now. Is GitHub Desktop already installed on your computer? **Check by typing 'GitHub Desktop' in the Windows search bar.**
