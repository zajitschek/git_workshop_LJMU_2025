...
3.  **Create repository:** Click **Create Repository**. GitHub Desktop will create the local repository in the folder you specified.
**!!** To just work locally, with version control, you could stop here. However, to backup your repository remotely, click **Publish repository**. This will publish/push the new repository to your GitHub account. 
