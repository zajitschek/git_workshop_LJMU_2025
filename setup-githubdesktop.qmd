...
3.  **Sign In:** You'll be prompted to **sign in to your GitHub.com account**. This is a crucial step that connects the application to your online repositories. If you don't have an account, you'll need to create one first on the [GitHub website](https://github.com/).
...
## 4. Standard Workflow: Commit & Push
