...
## 6. Working with Branches (A Best Practice, but not essential, especially for <2 users of the same repo)
...
A branch is essentially a lightweight, movable pointer to a specific commit. When you create a new branch, you're **not** creating a full copy of your project's files (there's no separate folder for each branch). Instead, you're creating a new pointer that initially points to the same commit as the branch you branched from (e.g., 'main').
